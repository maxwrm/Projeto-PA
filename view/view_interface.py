...
class ViewInterface(Tk):
    def __init__(self):
        ...
        label_cor_preenchimento.grid(column=2, row=1, sticky=W, **self.paddings)
        ...
        option_menu_cor_preenchimento.grid(column=3, row=1, sticky=W, **self.paddings)

        # label - cor - borda
        label_cor_borda = ttk.Label(self.frame, text='Cores de borda:')
        label_cor_borda.grid(column=4, row=1, sticky=W, **self.paddings)
        ...
        option_menu_cor_borda.grid(column=5, row=1, sticky=W, **self.paddings)
        ...
        botao_limpar.grid(column=7, row=0, sticky=W, **self.paddings)
