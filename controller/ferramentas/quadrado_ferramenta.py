...
class Quadrado_Ferramenta(Ferramenta):
    ...
    def mouse_pressionado(self, event):
        self.figura_nova = Quadrado(event, fill=self.controlador.view_interface.get_cor_preenchimento(), outline=self.controlador.view_interface.get_cor_borda(), width=self.controlador.view_interface.get_espessura())
